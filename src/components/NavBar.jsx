...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white relative dark:bg-gray-900 shadow-md w-full z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex space-x-6 items-center">
            ...
            <NavLink to="/about" className="text-gray-700 dark:text-gray-200 hover:text-green-600">Buy</NavLink>
            <NavLink to="/services" className="text-gray-700 dark:text-gray-200 hover:text-green-600">Rent</NavLink>
