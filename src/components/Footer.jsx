      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-300">
            <li className="hover:text-orange-200 cursor-pointer"><Link to="/">Home</Link></li>
            <li className="hover:text-orange-200 cursor-pointer"><Link to="/buy">Buy</Link></li>
            <li className="hover:text-orange-200 cursor-pointer"><Link to="/rent">Rent</Link></li>
            <li className="hover:text-orange-200 cursor-pointer"><Link to="/contact">contact</Link></li>
          </ul>
        </div>
